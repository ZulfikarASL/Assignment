...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30 full_view" style="background-image: url(<?php echo $this->theme->baseUrl ?>/assets/media/error/bg1.jpg);">
        <!--begin::Content-->
